    ...
    function updateTask(e) {
       ...
       var request = objectStore.get(id);
        ...
        request.onsuccess = function(e) {
           var selectedTask = e.target.result;
           var updateValue = taskInput.value
        
           selectedTask.taskname = updateValue ;

           objectStore.put(selectedTask);
       }
